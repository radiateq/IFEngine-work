(function() {
        ...
        Promise.all([ loadLearningPathInformation(pathId), contentLoaded ]).then(function(_a) {
            ...
            user.whenAuthenticated().then(function() {
                ...
                if (completedCount === learningPath.modules.length) {
                    ...
                    if (continueUnitUrl !== "") {
                        renderStartContinueUnitButton(moduleSummaries[continueModuleIndex], "/" + userLocale + continueUnitUrl, loc_continue, "continue");
                        initExpanders(continueModuleIndex);
                    } else if (startUnitUrl !== "") {
                        renderStartContinueUnitButton(moduleSummaries[startModuleIndex], "/" + userLocale + startUnitUrl, loc_start, "start");
    ...
    function displayTimeRemaining(timeRemaining) {
        document.getElementById("time-remaining").textContent = convertMinsToHrsMins(timeRemaining) + " " + loc_remaining;
    }
    ...
    function displayModuleCardDetails(module, unitCount, timeRemaining) {
        ...
        if (moreInfoCount > 0) {
            ...
            var html = ' <a href="' + link.href + '">' + loc_moreInfo + "</a>";
        ...
        Promise.all([ currentModule, contentLoaded ]).then(function(_a) {
            ...
            bus.subscribe(UnitProgressCheckedEvent, function(event) {
                ...
                bus.subscribe(ProgressUpdatedEvent, function(data) {
                    ...
                    if (user.isAuthenticated) {
                        isReturnModuleVisit = !event.updated && module.status === "completed";
                    } else {
                    ...
                    updateProgressElements(progressElements$2, data.standardProgress);
