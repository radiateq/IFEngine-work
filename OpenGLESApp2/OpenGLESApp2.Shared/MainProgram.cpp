...
unsigned int BounceBrainTrainSizeLimit = 100, PaddleBrainsTrainSizeLimit = 200;
unsigned int Node2_1_train_size_limit = 100, select1_data_counter_limit = 100, select2_data_counter_limit = 100;
